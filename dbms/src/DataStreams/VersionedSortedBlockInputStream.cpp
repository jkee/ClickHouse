...
void VersionedSortedBlockInputStream::insertRow(ColumnPlainPtrs & merged_columns, size_t & merged_rows)
{
...
Block VersionedSortedBlockInputStream::readImpl()
{
    if (finished)
        return Block();
...
void VersionedSortedBlockInputStream::merge(ColumnPlainPtrs & merged_columns, std::priority_queue<TSortCursor> & queue)
{
